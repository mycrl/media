...
class Ikan {
     ...
     */
    constructor() {
        this._http = new Http2(config.host)
    }
     ...
     */
     async poll() {
        for (const symbol of config.books)
 ...
 * @readonly
 */
exports.twosixy = ref_cell('twosixy', () => {
    return new Twosixy()
})
